...
export async function solveNutrients(params: PlanParams, loaders: {
  ...
  const lines: PlanLine[] = [
    { salt: caNo3.name, grams: round3(g_cano3_per_L * volumeL), tank: 'A' as const },
    { salt: kNo3.name,  grams: round3(g_kno3_per_L  * volumeL), tank: 'B' as const },
    { salt: kh2po4.name,grams: round3(g_kh2po4_per_L* volumeL), tank: 'B' as const },
    { salt: mgso4.name, grams: round3(g_mgso4_per_L * volumeL), tank: 'B' as const }
