...
import { getFarms, getDevices, getSensors, getLatestSensorReadings, Farm, Device, Sensor, SensorReading, getSupabaseClient } from '../lib/supabase';
    ...
    const loadData = async () => {
      try {
        ...
        if (farmsResult && Array.isArray(farmsResult)) {
          ...
          console.log('  - 베드:', devicesList.filter((d: any) => d?.type === 'sensor_gateway').length, '개');
