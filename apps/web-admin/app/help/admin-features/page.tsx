...
export default function AdminFeaturesPage() {
  ...
  const renderOverview = () => (
    <div className="space-y-2 sm:space-y-3">
        ...
        <div className="bg-white rounded-lg p-2 sm:p-3 border border-gray-200">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 font-medium">계정 및 권한 관리</p>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg p-2 sm:p-3 border border-gray-200">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 font-medium">농장 생성 및 설정</p>
            </div>
          </div>
          <ul className="space-y-2 text-sm text-gray-700 font-medium">
            <li>• 농장 생성/삭제</li>
        ...
        <div className="bg-white rounded-lg p-2 sm:p-3 border border-gray-200">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 font-medium">전역 설정 관리</p>
            </div>
          </div>
          <ul className="space-y-2 text-sm text-gray-700 font-medium">
            <li>• 시스템 환경 설정</li>
        ...
        <div className="bg-white rounded-lg p-2 sm:p-3 border border-gray-200">
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700 font-medium">보안 정책 및 모니터링</p>
            </div>
          </div>
          <ul className="space-y-2 text-sm text-gray-700 font-medium">
            <li>• 접근 로그 모니터링</li>
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <h4 className="font-semibold text-gray-900 mb-2">사용자 역할</h4>
          ...
          <div>
            <h4 className="font-semibold text-gray-900 mb-2">접근 권한</h4>
            <div className="space-y-2">
  ...
  const renderUserManagement = () => (
    <div className="space-y-6">
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-200">
                <th className="text-left py-3 px-4 font-semibold text-gray-800">사용자</th>
                <th className="text-left py-3 px-4 font-semibold text-gray-800">역할</th>
                <th className="text-left py-3 px-4 font-semibold text-gray-800">상태</th>
                <th className="text-left py-3 px-4 font-semibold text-gray-800">마지막 접속</th>
                <th className="text-left py-3 px-4 font-semibold text-gray-800">액션</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-gray-100">
                <td className="py-3 px-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-700 font-medium">admin@farm.com</div>
                    </div>
                  </div>
                </td>
                <td className="py-3 px-4">
                ...
                <td className="py-3 px-4 text-sm text-gray-700 font-medium">5분 전</td>
                <td className="py-3 px-4">
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200">
        <h3 className="text-lg font-bold text-gray-900 mb-4">➕ 새 사용자 초대</h3>
        <div className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-2">
              <label className="block text-sm text-gray-800 font-semibold">이메일 주소 *</label>
              <input 
                type="email" 
            ...
            <div className="space-y-2">
              <label className="block text-sm text-gray-800 font-semibold">역할 선택 *</label>
    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg p-2 sm:p-3 border border-gray-200">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <label className="block text-sm text-gray-800 font-semibold">농장명 *</label>
              <input 
                type="text" 
                placeholder="예: 스마트팜 서울농장"
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-gray-900 placeholder-gray-600"
              />
            </div>
            
            <div className="space-y-2">
              <label className="block text-sm text-gray-800 font-semibold">농장 위치</label>
              <input 
                type="text" 
            ...
            <div className="space-y-2">
              <label className="block text-sm text-gray-800 font-semibold">농장 설명</label>
              <textarea 
        ...
        <div className="bg-white rounded-lg p-2 sm:p-3 border border-gray-200">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <label className="block text-sm text-gray-800 font-semibold">농장 선택</label>
            ...
            <div className="space-y-2">
              <label className="block text-sm text-gray-800 font-semibold">사용자 선택</label>
              <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-gray-900">
            ...
            <div className="space-y-2">
              <label className="block text-sm text-gray-800 font-semibold">역할</label>
              <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-gray-900">
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200">
        <h3 className="text-lg font-bold text-gray-900 mb-4">📊 농장 통계</h3>
        <div className="grid md:grid-cols-4 gap-4">
          <div className="text-center p-4 bg-green-50 rounded-lg">
            <div className="text-2xl font-bold text-green-700">12</div>
            <div className="text-sm text-gray-700 font-medium">총 농장 수</div>
          </div>
          <div className="text-center p-4 bg-blue-50 rounded-lg">
            <div className="text-2xl font-bold text-blue-700">45</div>
            <div className="text-sm text-gray-700 font-medium">활성 디바이스</div>
          </div>
          <div className="text-center p-4 bg-purple-50 rounded-lg">
            <div className="text-2xl font-bold text-purple-700">156</div>
            <div className="text-sm text-gray-700 font-medium">총 센서</div>
          </div>
          <div className="text-center p-4 bg-orange-50 rounded-lg">
            <div className="text-2xl font-bold text-orange-700">89</div>
            <div className="text-sm text-gray-700 font-medium">활성 사용자</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg p-2 sm:p-3 border border-gray-200">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-800 font-semibold">이메일 알림</span>
              <input type="checkbox" className="w-4 h-4 text-purple-600" defaultChecked />
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-800 font-semibold">SMS 알림</span>
              <input type="checkbox" className="w-4 h-4 text-purple-600" />
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-800 font-semibold">푸시 알림</span>
              <input type="checkbox" className="w-4 h-4 text-purple-600" defaultChecked />
            </div>
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-800 font-semibold">텔레그램 알림</span>
              <input type="checkbox" className="w-4 h-4 text-purple-600" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-2 sm:p-3 border border-gray-200">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <label className="block text-sm text-gray-800 font-semibold">기본 시간대</label>
            ...
            <div className="space-y-2">
              <label className="block text-sm text-gray-800 font-semibold">데이터 보관 기간</label>
              <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-900">
            ...
            <div className="space-y-2">
              <label className="block text-sm text-gray-800 font-semibold">자동 백업 주기</label>
              <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent text-gray-900">
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200">
        <h3 className="text-lg font-bold text-gray-900 mb-4">💾 데이터베이스 관리</h3>
        <div className="grid md:grid-cols-3 gap-4">
          <div className="text-center p-4 bg-blue-50 rounded-lg">
            <div className="text-2xl font-bold text-blue-700">2.3GB</div>
            <div className="text-sm text-gray-700 font-medium">현재 사용량</div>
          </div>
          <div className="text-center p-4 bg-green-50 rounded-lg">
            <div className="text-2xl font-bold text-green-700">15.7GB</div>
            <div className="text-sm text-gray-700 font-medium">사용 가능</div>
          </div>
          <div className="text-center p-4 bg-purple-50 rounded-lg">
            <div className="text-2xl font-bold text-purple-700">87%</div>
            <div className="text-sm text-gray-700 font-medium">여유 공간</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="space-y-2 sm:space-y-3">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg p-2 sm:p-3 border border-gray-200">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <label className="block text-sm text-gray-800 font-semibold">비밀번호 정책</label>
              <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent text-gray-900">
            ...
            <div className="space-y-2">
              <label className="block text-sm text-gray-800 font-semibold">세션 타임아웃</label>
              <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent text-gray-900">
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-800 font-semibold">2단계 인증</span>
              <input type="checkbox" className="w-4 h-4 text-red-600" defaultChecked />
            </div>
            
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-800 font-semibold">IP 화이트리스트</span>
        ...
        <div className="bg-white rounded-lg p-2 sm:p-3 border border-gray-200">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
              <div>
                <div className="font-semibold text-gray-900">admin@farm.com</div>
                <div className="text-sm text-gray-700 font-medium">시스템 관리자</div>
              </div>
              <div className="text-right">
                <div className="text-sm text-gray-700 font-medium">5분 전</div>
            ...
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
              <div>
                <div className="font-semibold text-gray-900">kim@farm.com</div>
                <div className="text-sm text-gray-700 font-medium">팀 리더</div>
              </div>
              <div className="text-right">
                <div className="text-sm text-gray-700 font-medium">12분 전</div>
                <div className="text-xs text-green-700 font-semibold">성공</div>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
              <div>
                <div className="font-semibold text-gray-900">unknown@hacker.com</div>
                <div className="text-sm text-gray-700 font-medium">외부 접근 시도</div>
              </div>
              <div className="text-right">
                <div className="text-sm text-gray-700 font-medium">1시간 전</div>
      ...
      <div className="bg-white rounded-lg p-6 border border-gray-200">
        <h3 className="text-lg font-bold text-gray-900 mb-4">🚨 보안 알림</h3>
        <div className="grid md:grid-cols-3 gap-4">
          <div className="text-center p-4 bg-red-50 rounded-lg">
            <div className="text-2xl font-bold text-red-700">3</div>
            <div className="text-sm text-gray-700 font-medium">실패한 로그인</div>
          </div>
          <div className="text-center p-4 bg-yellow-50 rounded-lg">
            <div className="text-2xl font-bold text-yellow-700">1</div>
            <div className="text-sm text-gray-700 font-medium">의심스러운 활동</div>
          </div>
          <div className="text-center p-4 bg-green-50 rounded-lg">
            <div className="text-2xl font-bold text-green-700">156</div>
            <div className="text-sm text-gray-700 font-medium">정상 로그인</div>
          </div>
        </div>
      </div>
    </div>
