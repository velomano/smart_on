...
nutrient_recipes (자동 수집 레시피 저장) ← 통일된 테이블
...
- 개별/전체 소스 수집 엔드포인트
- **Supabase REST API 직접 연동** (Edge Function 대신)
...
### 데이터베이스
- ✅ **nutrient_recipes 테이블**: 12건 자동 수집 레시피 저장 완료
- ✅ **crop_profiles 테이블**: 기존 수동 입력 레시피 유지
- ✅ **다양한 작물**: 상추, 토마토, 딸기, 오이, 고추
- ✅ **모든 생장 단계**: seedling, vegetative, flowering, fruiting, ripening
- ✅ **상세 정보**: EC, pH, NPK 비율, 영양소 상세, 사용법, 주의사항
- ✅ **중복 방지**: 고유 checksum으로 중복 데이터 방지
